...
#         super().__init__(name,master_surface,x,y,w,h,color_background,color_border,active)  #! HEREDAR
...
#         # --- GAME ELEMNTS --- 
#         self.static_background = Background(x=0,y=0,width=w,height=h,path="backgrounds/0.png")

#         # self.player_1 = Player(x=0,y=400,speed_walk=6,speed_run=12,gravity=14,jump_power=30,frame_rate_ms=100,move_rate_ms=50,jump_height=140,p_scale=2,interval_time_jump=300)
...
#         self.plataform_list = []
#         self.plataform_list.append(Plataform(x=550,y=600,width=50,height=50,type=10))
