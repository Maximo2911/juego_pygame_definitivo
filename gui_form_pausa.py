...
class FormPausa(Form):
    ...
    def __init__(self,name,master_surface,x,y,w,h,color_background,imagen_background,color_border,active):
        ...
        self.text1 = Widget(master=self,x=100,y=50,w=100,h=50,color_background=None,color_border=None,image_background=None,text="PAUSA",font="consola",font_size=30,font_color=WHITE)
        self.boton1 = Button(master=self,x=50,y=130,w=70,h=70,color_background=None,color_border=None,image_background=r"buttoms\mini_continue\0.png",on_click=self.on_click_boton1,on_click_param="salir",text=None,font=None,font_size=None,font_color=None)
        ...
        self.boton3 = Button(master=self,x=50,y=210,w=70,h=70,color_background=None,color_border=None,image_background=r"buttoms\mini_quit\0.png",on_click=self.on_click_boton1,on_click_param="menu",text=None,font=None,font_size=None,font_color=None)
        self.boton4 = Button(master=self,x=180,y=210,w=70,h=70,color_background=None,color_border=None,image_background=r"buttoms\mini_house\0.png",on_click=self.on_click_boton1,on_click_param="niveles",text=None)
        ...
        self.lista_widget = [self.boton1,self.boton3,self.boton4,self.text1]
