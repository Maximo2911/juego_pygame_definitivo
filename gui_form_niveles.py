...
class FormNiveles(Form):
    ...
    def __init__(self,name,master_surface,x,y,w,h,color_background,imagen_background,color_border,active):
        ...
        self.boton1 = Button(master=self,x=380,y=200,w=100,h=350,color_background=None,color_border=None,image_background=r"buttoms\level_one\1.png",on_click=self.on_click_boton_nivel,on_click_param="nivel_1",text="1",font="Anonymus Pro",font_size=30,font_color=WHITE)
        self.boton2 = Button(master=self,x=ANCHO_PANTALLA//2- 55,y=200,w=100,h=350,color_background=None,color_border=None,image_background=r"buttoms\level_two\1.png",on_click=self.on_click_boton_nivel,on_click_param="nivel_2",text="2",font="Anonymus Pro",font_size=30,font_color=WHITE)
        self.boton3 = Button(master=self,x=780,y=200,w=100,h=350,color_background=None,color_border=None,image_background=r"buttoms\level_three\1.png",on_click=self.on_click_boton_nivel,on_click_param="nivel_3",text="3",font="Anonymus Pro",font_size=30,font_color=WHITE)
